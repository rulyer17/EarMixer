...
namespace EarTrumpet.UI.ViewModels
{
    public class FlyoutViewModel : BindableBase, IPopupHostViewModel, IFlyoutViewModel
    {
        ...
        public FlyoutViewModel(
            DeviceCollectionViewModel mainViewModel,
            DeviceCollectionViewModel recordingViewModel,
            DataModel.Audio.IAudioDeviceManager recordingDeviceManager,
            Action returnFocusToTray,
            AppSettings settings)
        {
            ...
            Microphone = new MicrophoneViewModel(recordingViewModel, recordingDeviceManager);
            Microphone.PropertyChanged += (_, __) => InvalidateWindowSize();
