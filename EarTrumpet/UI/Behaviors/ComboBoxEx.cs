...
namespace EarTrumpet.UI.Behaviors
{
    public class ComboBoxEx
    {
        ...
        private static void OnComboBoxItemPreviewMouseLeftButtonDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            // This behavior belongs to the Settings search box.  Other
            // flyout selectors may use ComboBoxItem too, so do not assume
            // every item is a SettingsSearchItemViewModel.
            if (!(comboBoxItem.DataContext is SettingsSearchItemViewModel item))
            {
                return;
            }
