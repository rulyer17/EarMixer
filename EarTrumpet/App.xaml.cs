...
namespace EarTrumpet
{
    public partial class App
    {
        ...
        private DeviceCollectionViewModel _recordingCollectionViewModel;
        ...
        private void ContinueStartup()
        {
            ...
            _recordingCollectionViewModel = new DeviceCollectionViewModel(recordingDeviceManager, Settings);
